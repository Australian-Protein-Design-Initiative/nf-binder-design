process RFDIFFUSION_PARTIAL {
    ...
    publishDir path: "${params.outdir}/rfd/rfdiffusion", pattern: 'pdbs/partial/*/*.pdb', mode: 'copy'
    publishDir path: "${params.outdir}/rfd/rfdiffusion", pattern: 'traj/partial/*/*.pdb{,.gz}', mode: 'copy'
    publishDir path: "${params.outdir}/rfd/rfdiffusion", pattern: 'configs/partial/*/*/*.yaml', mode: 'copy'
    publishDir path: "${params.outdir}/rfd/rfdiffusion", pattern: 'logs/partial/*/*/*.log', mode: 'copy'
