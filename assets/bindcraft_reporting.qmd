...
if total_trajectories > 0:
    ...
    ">
        <h2 style="text-align: center; font-size: 28px; color: #2c3e50; margin: 0 0 8px 0;">
            Accept rate: {rate_unique:.1f}% ({accepted_unique_count} unique / {total_trajectories} trajectories)
        </h2>
        <p style="text-align: center; color: #5d6d7e; margin: 0 0 4px 0; font-size: 14px;">
            Headline rate collapses MPNN duplicates (multiple accepted sequences from the same trajectory count once).
        </p>
        <p style="text-align: center; color: #5d6d7e; margin: 0 0 16px 0; font-size: 14px;">
            Including MPNN duplicates: {rate_all:.1f}% ({accepted_all_count} accepted / {total_trajectories} trajectories)
        </p>
        <table style="
            width: 100%;
...
if has_multiple_targets:
    # Accepted designs first (may be skipped when only one target has accepts)
